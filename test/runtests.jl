...
# !!! Main.UserApp is configured as an alias for Main.LinkSUS and you might encounter it in some tests
using Main.LinkSUS, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "LinkSUS tests" begin
  @includetests ARGS
end
